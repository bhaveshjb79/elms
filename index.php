...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>BHS INFOTECH | Employee Page</title>
...
body
{
    ...
    background-image: url("https://initiate.alphacoders.com/images/559/stretched-1921-1080-559881.jpg?1321");    
   ...
   .card-content  
    ...
    <body>
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            <a class="nav-item text-white font-weight-bold nav-link ml-4" href="admin/">Admin Login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-4" href="index.php">Employee Login</a>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  ...
                                  <div class="card-content ">
                                      ...
                                      <span class="card-title text-blue" style="font-size:20px;">Employee Login</span>
